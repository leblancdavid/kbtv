...
{
    /// <summary>
    /// Special stat bar for Spirit (-50 to +50 range) with centered display.
    /// Bar fills left (red) for negative values, right (green) for positive.
    /// Format: "SPIRIT   [░░░░░░░░░░|███░░░░░░]  +10"
    /// </summary>
    public partial class SpiritBar : HBoxContainer
    {
        ...
        /// <summary>
        /// Bind this bar to the Spirit stat. Subscribes to value changes for real-time updates.
        /// </summary>
        ...
        private void UpdateBarDisplay()
        {
            ...
            // Range is -50 to +50, center is 0
            float minValue = _stat.MinValue; // -50
            float maxValue = _stat.MaxValue; // +50
            float range = maxValue - minValue; // 100
            ...
            Color valueColor = UIColors.GetSpiritColor(_displayValue);
