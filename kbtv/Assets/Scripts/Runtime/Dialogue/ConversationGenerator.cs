...
namespace KBTV.Dialogue
{
    ...
    public class ConversationGenerator
    {
        ...
        public Conversation Generate(Caller caller, Topic currentTopic = null)
        {
            ...
            VernResponseType challengeResponse = DetermineVernChallengeType(caller);

            // Build the four-phase conversation structure
        ...
        private enum CallerPhase { Intro, Detail, Defense, Acceptance, Conclusion }
        ...
        private VernResponseType DetermineVernChallengeType(Caller caller)
        {
            ...
            if (_vernStats?.Energy == null)
            {
                return caller.Legitimacy switch
                {
                    ...
                    CallerLegitimacy.Credible => VernResponseType.Probing,
            ...
            // High belief + compelling caller = believing
